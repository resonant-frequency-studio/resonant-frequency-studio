...
export default function Projects() {
  ...
  return (
    <section id="works" className="bg-brand-ink text-brand-ivory">
      <div>
        <div className="container mx-auto w-full px-4 md:px-12">
          <div className="max-w-3xl">
            ...
            <h3 className="mt-6 text-4xl font-semibold leading-tight md:text-6xl lg:text-7xl">
              Recent partnerships that shipped clarity and conversion.
            </h3>
            <p className="mt-6 text-lg text-brand-ivory/75 md:text-xl">
          ...
          <div className="space-y-8">
            {PROJECTS.map((project, index) => (
              ...
              >
                ...
                <p className="mt-2 text-sm uppercase tracking-[0.32em] text-brand-ivory/55">
                  {project.category}
                </p>
                ...
                <motion.div className="flex" style={{ x: translateX }}>
                  {PROJECTS.map((project, index) => (
                    ...
                    >
                      <article
                        className={cx(
                          'flex h-full flex-col justify-between rounded-[32px] border border-white/12 bg-black/35 p-12 text-left',
                      ...
                      >
                        <div className="space-y-6">
                          ...
                          <p className="text-sm uppercase tracking-[0.32em] text-brand-ivory/60">
                            {project.category}
                          </p>
                          <p className="max-w-xl text-lg text-brand-ivory/80">
                            {project.summary}
                          </p>
                        </div>
                        <div
                          className={cx(
                            'mt-10 h-64 w-full overflow-hidden rounded-[28px] border border-white/12',
