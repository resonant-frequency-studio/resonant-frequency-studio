...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative overflow-hidden h-screen min-h-[900px] bg-black"
    >
      <div
        className={cx(
          'absolute inset-0 z-10',
          "before:content-[''] before:absolute before:z-10 before:bottom-44 before:right-0 before:rounded-br-[15vw] before:shadow-[0_15vw_0_0_rgba(18,18,18,1)] before:bg-transparent before:w-[15vw] before:h-[30vw]",
          "after:content-[''] after:absolute after:bottom-0 after:right-0 after:left-0 after:h-44 after:w-full after:rounded-tl-[15vw] after:from-transparent after:bg-brand-ink"
        )}
      >
          ...
          <div className="flex flex-col gap-8 pointer-events-auto">
            ...
            <Link
              ...
              className={cx(
                ...
                'border border-white/40 bg-white/10 px-6 py-3 text-base',
